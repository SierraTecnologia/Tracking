...
namespace Tracking\Providers\Exemplos;
...
class HomeServiceProvider extends ServiceProvider
{
    ...
    protected function registerAppServices(): void
    {
        ...
        $this->app->bind(
            \Tracking\Services\Writelabel\Manifest\Contracts\Manifest::class,
            \Tracking\Services\Writelabel\Manifest\AppManifest::class
        );

        $this->app->bind(
            \Tracking\Services\Writelabel\SiteMap\Contracts\SiteMapBuilder::class,
            \Tracking\Services\Writelabel\SiteMap\AppSiteMapBuilder::class
        );

        $this->app->bind(
            \Tracking\Services\Writelabel\Rss\Contracts\RssBuilder::class,
            \Tracking\Services\Writelabel\Rss\AppRssBuilder::class
        );
